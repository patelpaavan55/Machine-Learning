...
class linear_layer:
    ...
    def __init__(self, input_D, output_D):
        ...
        ###############################################################################################
        mean, sigma = 0, 0.1 
        self.params['W']=np.random.normal(mean, sigma, (input_D, output_D))
        self.params['b']=np.random.normal(mean, sigma, (1, output_D))
